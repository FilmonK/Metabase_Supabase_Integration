...
4. Edit Your Function:
   ...
   - 👉 Here's a link to the sample code: [Supabase Edge Function](https://github.com/FilmonK/Metabase_Supabase_Integration/blob/main/supabase_edgefunctions/playerStartUsage.js)
